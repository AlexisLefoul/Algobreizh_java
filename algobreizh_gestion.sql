...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 07 juin 2021 à 23:33
...
CREATE TABLE IF NOT EXISTS `accountingexchangegroup` (
  ...
  `sysCreatedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysModifiedDate` datetime DEFAULT NULL,
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `GroupNumber` int NOT NULL DEFAULT '0',
  `System` tinyint(1) NOT NULL DEFAULT '0',
  `TransferedPieces` tinyint(1) NOT NULL DEFAULT '0',
  `ProcessType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
CREATE TABLE IF NOT EXISTS `accountingexchangegroupprocessdetail` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` int NOT NULL,
  `AccountingExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ProcessType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ProcessDate` datetime NOT NULL,
  `Errors` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `address` (
  ...
  `AddressFields_Address1` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_Address2` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_Address3` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_Address4` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_ZipCode` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_City` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_State` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_CountryIsoCode` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_Description` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_ThirdName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_Npai` tinyint(1) NOT NULL DEFAULT '0',
  `AddressFields_WebSite` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `AssociatedCustomerId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AssociatedSupplierId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `analyticgrid` (
  ...
  `sysModifiedDate` datetime DEFAULT NULL,
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `NotesClear` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `analyticgridline` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` int NOT NULL,
  `AnalyticPlanItem` int NOT NULL,
  `Percentage` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `AnalyticGridId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `analyticplan` (
  ...
  `WaitingPlanItemId` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `analyticplanitem` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` int NOT NULL,
  `Code` varchar(13) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `FullPathCode` varchar(169) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PlanId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bank` (
  ...
  `Caption` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `BankBook` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `AccountingAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '512',
  `Address_Address1` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_Address2` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_Address3` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_Address4` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_ZipCode` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_City` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_State` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_CountryIsoCode` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_BankName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_WebSite` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_Longitude` decimal(20,8) DEFAULT NULL,
  `Address_Latitude` decimal(20,8) DEFAULT NULL,
  `Contact_Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_Name` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_FirstName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_Phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_CellPhone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_Fax` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_Email` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_Function` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_Department` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountDetail_BasicBankAccountNumber` varchar(46) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountDetail_InternationalBankAccountNumber` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountDetail_BankIdentifierCode` varchar(11) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `NationalIssuerNumber` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `FormatCfonbFile` tinyint(1) NOT NULL DEFAULT '0',
  `FormatSepaFile` tinyint(1) NOT NULL DEFAULT '0',
  `SepaCreditorIdentifier` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `CurrencyId` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `BillOfExchangeBook` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'OD',
  `BillForCollectionBook` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'OD',
  `BillForDiscountBook` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'OD',
  `OtherPaymentBook` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'OD',
  `BillForCollectionAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '5113',
  `BillForDiscountAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '5114',
  `OtherPaymentAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '5112',
  `BankRemittanceCharges0_Caption` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `BankRemittanceCharges0_Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `BankRemittanceCharges0_AmountType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `BankRemittanceCharges0_Account` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '627',
  `BankRemittanceCharges0_PaymentTypes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `BankRemittanceCharges1_Caption` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `BankRemittanceCharges1_Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `BankRemittanceCharges1_AmountType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `BankRemittanceCharges1_Account` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '627',
  `BankRemittanceCharges1_PaymentTypes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `BankRemittanceCharges2_Caption` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `BankRemittanceCharges2_Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `BankRemittanceCharges2_AmountType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `BankRemittanceCharges2_Account` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '627',
  `BankRemittanceCharges2_PaymentTypes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `BankRemittanceCharges3_Caption` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `BankRemittanceCharges3_Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `BankRemittanceCharges3_AmountType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `BankRemittanceCharges3_Account` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '627',
  `BankRemittanceCharges3_PaymentTypes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `BankRemittanceCharges4_Caption` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `BankRemittanceCharges4_Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `BankRemittanceCharges4_AmountType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `BankRemittanceCharges4_Account` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '627',
  `BankRemittanceCharges4_PaymentTypes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysModuleId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysDatabaseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `bankremittance` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `BankRemittanceNumber` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `BankRemittanceDate` date NOT NULL,
  `BankId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PaymentTypeId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `BankRemittanceState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `CurrencyAmount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `AccountingExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CfonbFileGenerated` tinyint(1) NOT NULL DEFAULT '0',
  `LastSepaMessageId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CurrencyId` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CurrencyConversionRate` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `ChargesEntryDate` date DEFAULT NULL,
  `RemittanceType` tinyint UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `calcultateddatamodel` (
  ...
  `sysEditCounter` int DEFAULT '0',
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(120) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Purpose` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `Program_Program` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `civility` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `classificationgroup` (
  ...
  `GroupType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `AnalyticAccounting_GridId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `colleague` (
  ...
  `Contact_Fax` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_Email` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_ColleagueFunction` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IsSalesperson` tinyint(1) NOT NULL DEFAULT '1',
  `UserId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `GeographicSector` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ColleagueFamilyId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Group1` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Group2` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MaximumDiscountRateAllowed` decimal(28,8) DEFAULT NULL,
  `ActiveState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `CifNif` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IRPFRate` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `AnalyticAccounting_GridId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `StorehouseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `EmployeeRegistrationNumber` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SalePriceVatExcluded` decimal(28,8) DEFAULT '0.00000000',
  `HourlyCostPrice` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `ReferenceItemId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `EmployeePayrollId` int DEFAULT NULL,
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysEditCounter` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `colleagueassociatedfiles` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ParentId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Content` longblob,
  `DocumentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `colleaguefunction` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `commissionscale` (
  ...
  `CSScope` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ObjectiveType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `Mode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `GroupBy` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000',
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `commissionscalecolleagueline` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `CommissionScaleId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ColleagueId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ColleagueFamilyId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `commissionscaleselectionline` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `CommissionScaleId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SelectionType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `IdFrom` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IdTo` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Exclude` tinyint(1) NOT NULL DEFAULT '0',
  `SelectionOrder` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `complementarydiscount` (
  ...
  `Caption` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `SaleAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '709',
  `PurchaseAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '609',
...
CREATE TABLE IF NOT EXISTS `contact` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ContactFields_Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ContactFields_Name` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ContactFields_FirstName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ContactFields_Phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ContactFields_CellPhone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ContactFields_Fax` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ContactFields_Email` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ContactFields_Function` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ContactFields_Department` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ContactFields_NaturalPerson` tinyint(1) NOT NULL DEFAULT '1',
  `ContactFields_OptIn` tinyint(1) NOT NULL DEFAULT '0',
  `ContactFields_ExternalId_GoogleId` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ContactFields_ExternalId_OutlookId` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_Address1` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_Address2` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_Address3` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressFields_Address4` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `AddressFields_Longitude` decimal(20,8) DEFAULT NULL,
  `AddressFields_Latitude` decimal(20,8) DEFAULT NULL,
  `OtherAddressFields_Address1` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_Address2` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_Address3` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_Address4` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_ZipCode` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_City` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_State` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_CountryIsoCode` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_Description` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_ThirdName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherAddressFields_Npai` tinyint(1) NOT NULL DEFAULT '0',
  `OtherAddressFields_WebSite` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `contactassociatedfiles` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ParentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Content` longblob,
  `DocumentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `sysEditCounter` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `contactecommerceinfo` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ParentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `InfoKey` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `InfoValue` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `correctionreason` (
  ...
  `Caption` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `country` (
  ...
  `Caption` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `currencytable` (
  ...
  `Id` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Symbol` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `DecimalCount` tinyint UNSIGNED NOT NULL DEFAULT '2',
  ...
  `SalesJournal` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PurchasesJournal` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `MainDeliveryAddress_Address1` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_Address2` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_Address3` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_Address4` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_ZipCode` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_City` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_State` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_CountryIsoCode` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_Description` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_ThirdName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_Npai` tinyint(1) NOT NULL DEFAULT '0',
  `MainDeliveryAddress_WebSite` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryAddress_Longitude` decimal(20,8) DEFAULT NULL,
  `MainDeliveryAddress_Latitude` decimal(20,8) DEFAULT NULL,
  `MainInvoicingAddress_Address1` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_Address2` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_Address3` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_Address4` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_ZipCode` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_City` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_State` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_CountryIsoCode` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_Description` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_ThirdName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_Npai` tinyint(1) NOT NULL DEFAULT '0',
  `MainInvoicingAddress_WebSite` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingAddress_Longitude` decimal(20,8) DEFAULT NULL,
  `MainInvoicingAddress_Latitude` decimal(20,8) DEFAULT NULL,
  `MainDeliveryContact_Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryContact_Name` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryContact_FirstName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryContact_Phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryContact_CellPhone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryContact_Fax` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryContact_Email` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryContact_Function` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryContact_Department` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryContact_NaturalPerson` tinyint(1) NOT NULL DEFAULT '1',
  `MainDeliveryContact_OptIn` tinyint(1) NOT NULL DEFAULT '0',
  `MainDeliveryContact_ExternalId_GoogleId` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainDeliveryContact_ExternalId_OutlookId` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_Name` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_FirstName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_Phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_CellPhone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_Fax` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_Email` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_Function` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_Department` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_NaturalPerson` tinyint(1) NOT NULL DEFAULT '1',
  `MainInvoicingContact_OptIn` tinyint(1) NOT NULL DEFAULT '0',
  `MainInvoicingContact_ExternalId_GoogleId` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainInvoicingContact_ExternalId_OutlookId` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `NaturalPerson` tinyint(1) NOT NULL DEFAULT '1',
  `ThirdLanguage` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'FR',
  `PriceListCategoryId` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Siren` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `NAF` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `FamilyId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SubFamilyId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IntracommunityVATNumber` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TerritorialityId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `FirstInvoicingDate` date DEFAULT NULL,
  `SettlementModeId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PaymentDate` smallint DEFAULT NULL,
  ...
  `Accounts_Account` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Accounts_BillOfExchangeAccountingAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `FinancialDiscountType` tinyint UNSIGNED NOT NULL DEFAULT '1',
  `FinancialDiscountRate` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `FinancialDiscountPaymentDelay` smallint NOT NULL DEFAULT '0',
  `ActiveState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `CurrencyId` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Group1` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Group2` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `DocumentSerialId` varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IdentificationType` tinyint UNSIGNED DEFAULT NULL,
  `AnalyticAccounting_GridId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ThresholdBeforeExceedAmount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `TaxIds0` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TaxIds1` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TaxIds2` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ShippingId` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PaymentThirdId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `InvoicingThirdId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `SelectedReminderReport` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DayNumberToFirstReminder` int NOT NULL DEFAULT '5',
  `DayNumberToSecondReminder` int NOT NULL DEFAULT '5',
  `DayNumberToThirdReminder` int NOT NULL DEFAULT '5',
  `IsCustomerAccount` tinyint(1) NOT NULL DEFAULT '0',
  `WebContactSendKind` tinyint UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `customercustomreport` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DocumentSubType` tinyint UNSIGNED NOT NULL,
  `NumberOfCopies` int NOT NULL DEFAULT '1',
  `ParentId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PriceTaxeBased` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ReportId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `customerfamily` (
  ...
  `Caption` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `DiscountRate` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `TerritorialityId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SecondDiscountRate` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `PriceListCategoryId` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `FinancialDiscountRate` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `SettlementModeId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `customerfamilycustomreport` (
  ...
  `DocumentSubType` tinyint UNSIGNED NOT NULL,
  `NumberOfCopies` int NOT NULL DEFAULT '1',
  `ParentId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PriceTaxeBased` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ReportId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `customersubfamily` (
  ...
  `Id` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `CustomerFamilyId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `AnalyticAccounting_GridId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `deal` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `DealDate` date NOT NULL,
  `DealState` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `dealcolleague` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ColleagueId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `LastName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `FirstName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DealId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dealcustomer` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ThirdId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Name` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `DealId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dealextracost` (
  ...
  `UnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `VatId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `dealitem` (
  ...
  `ItemCaption` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Quantity` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  ...
  `DealId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ItemType` tinyint UNSIGNED NOT NULL DEFAULT '2',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `dealpurchasedocument` (
  ...
  `DocumentNumber` varchar(18) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DocumentDate` date NOT NULL,
  `TransferedDocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DealId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DocumentState` int DEFAULT NULL,
  `AmountVatExcluded` decimal(28,8) DEFAULT '0.00000000',
  `NetAmountVatExcludedWithDiscount` decimal(28,8) DEFAULT '0.00000000',
  ...
  `InvoiceCorrectionType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `DocumentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `SupplierId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SupplierName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `dealpurchasedocumentline` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ParentLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `LineType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `LineOrder` int NOT NULL DEFAULT '0',
  `DocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DocumentLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000',
  `Description` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `DescriptionClear` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `ItemId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Quantity` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `DealId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `QuantityDecimalNumber` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `PricesDecimalNumber` tinyint UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `dealpurchasesettlement` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SettlementId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ThirdId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ThirdName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `SettlementDate` date NOT NULL,
  `PaymentTypeId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `DealId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DepositLastAttachedDocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DepositLastAttachedDocumentType` tinyint UNSIGNED DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `dealresourcescost` (
  ...
  `DealId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ColleagueId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `EquipmentId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `NetAmountVatExcluded` decimal(28,8) NOT NULL DEFAULT '0.00000000',
...
CREATE TABLE IF NOT EXISTS `dealsaledocument` (
  ...
  `CustomerName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ColleagueId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `NetInterestAmount` decimal(28,8) DEFAULT '0.00000000',
  `GrossInterestAmount` decimal(28,8) DEFAULT '0.00000000',
  `InterestAmount` decimal(28,8) DEFAULT '0.00000000',
...
CREATE TABLE IF NOT EXISTS `dealstockdocument` (
  ...
  `DealId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DocumentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `StorehouseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `TargetStorehouseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `IncludedAmount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `disbursement` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DisbursementNumber` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `DisbursementDate` date NOT NULL,
  `BankId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PaymentTypeId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DisbursementState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `CurrencyAmount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `AccountingExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CfonbFileGenerated` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `documentlineassociation` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `OriginDocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `OriginLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `OriginDocumentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `OriginDocumentSubType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `TransferedLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `TransferedDocumentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `TransferedDocumentSubType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `TransferedDocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Quantity` decimal(28,8) NOT NULL DEFAULT '0.00000000',
...
CREATE TABLE IF NOT EXISTS `documentserial` (
  ...
  `Caption` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `DocumentSerialType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `IsDefault` tinyint(1) NOT NULL DEFAULT '0',
  `CorrectiveSerialId` varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SalesAccountingBook` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PurchasesAccountingBook` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysModuleId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysDatabaseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysRecordVersion` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ebpsysalert` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `TableName` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `LogicalSubTypeId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Caption` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  `MessageClear` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Message` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ValidityDateFrom` date DEFAULT NULL,
  `ValidityDateFromType` int DEFAULT '0',
  `ValidityDateTo` date DEFAULT NULL,
  `RemindDateTime` datetime DEFAULT NULL,
  `Inactive` tinyint(1) NOT NULL DEFAULT '0',
  `UserId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UserGroupdId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsysasynchronouslog` (
  ...
  `ConnectedMachine` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ExecutionDate` datetime NOT NULL,
  `Caption` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ErrorKind` tinyint UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ebpsysautoincrement` (
  `incName` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `incValue` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`incName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsysautotreecategory` (
  ...
  `sysModifiedDate` datetime DEFAULT NULL,
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ListId` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ViewNamespace` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `TreeCategoryName` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `TreeCategoryKey` int NOT NULL,
  `FirstFilter` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `SecondFilter` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsyscloudaccount` (
  ...
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000',
  `LastName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `FirstName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsyscloudaccountpublicationassociation` (
  ...
  `sysModifiedDate` datetime DEFAULT NULL,
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountId` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PublicationId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsysclouddocument` (
  ...
  `GeneratorId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Configuration` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `ebpsyscloudpublication` (
  ...
  `Folder` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Icon` longblob,
  `IconPreset` tinyint UNSIGNED NOT NULL DEFAULT '0',
  ...
  `Periodicity_Type` tinyint UNSIGNED NOT NULL DEFAULT '3',
  ...
  `Periodicity_DayRank` tinyint UNSIGNED DEFAULT '1',
  `Periodicity_DayRankSelector` tinyint(1) NOT NULL DEFAULT '1',
  `Periodicity_SelectedDayOfWeek` tinyint UNSIGNED DEFAULT '1',
  `Periodicity_DayNumber` tinyint UNSIGNED DEFAULT '1',
  `Periodicity_DayNumberSelector` tinyint(1) NOT NULL DEFAULT '0',
  `Periodicity_UserIncrement` int DEFAULT '1',
  `Periodicity_Caption` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsyscustomtreecategory` (
  ...
  `ViewNamespace` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `TreeCategoryName` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `TreeCategoryKey` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ParentId` varchar(27) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsysdashboard` (
  ...
  `sysModifiedDate` datetime DEFAULT NULL,
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OwningId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysEditCounter` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ebpsysdashboarddefaulttemplate` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UserId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `GroupId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` int NOT NULL,
  `DefaultTemplateId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `OwningId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsysdashboardpart` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DashboardId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PartId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PartInstanceId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsysdashboardtemplate` (
  ...
  `UserId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `GroupId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TemplateId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Label` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Template` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `OwningId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SystemDashboardId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CreationOrder` int NOT NULL DEFAULT '0',
  `sysEditCounter` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ebpsysdefaultreport` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ReportCategoryId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ElementType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ReportId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `NumberOfCopies` int NOT NULL DEFAULT '0',
  `ReportLanguage` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsysdeletedrecord` (
  ...
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Kind` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsysexchangeapplication` (
  `SourceApplicationId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SourceApplicationName` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `DestinationApplicationId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DestinationApplicationName` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ApplicationVersion` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `SourceDatabaseName` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ebpsysexchangelog` (
  ...
  `ApplicationId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ApplicationVersion` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `OperationType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsysgenericimportsettings` (
  ...
  `categoryId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `export` tinyint(1) NOT NULL,
  `formatId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `serializedEntity` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsyslock` (
  `keyValue` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `groupId` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `contextId` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000',
  `productName` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `productVersion` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `mainApplicationId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `userId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `userName` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `computerName` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ebpsysmachineinfo` (
  ...
  `sysModifiedDate` datetime DEFAULT NULL,
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MachineName` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `MachineKey` varchar(13) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `CompanyName` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ActivationCode` varchar(19) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ConnectionDate` datetime DEFAULT NULL,
  `WindowsUserName` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `WindowsDomain` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OsVersion` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MachineKeyInfo` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsysnavbartemplate` (
  ...
  `GroupId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TemplateId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Label` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Défaut',
  `Template` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `OwningId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`TemplateId`)
...
CREATE TABLE IF NOT EXISTS `ebpsysoptions` (
  `OptionName` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `OptionValue` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `OptionBlobValue` longblob,
  `LocalUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '¤GLOBAL¤',
  `LocalWorkstation` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '¤GLOBAL¤',
  `OptionHashCode` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsysquerytool` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ebpsysreport` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `CategoryId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `LevelId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Label` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  `ReportDesignState` tinyint UNSIGNED DEFAULT '0',
  `DesignerId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DesignerInfo` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `ebpsysreportsavedsettings` (
  ...
  `Label` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ReportCategoryId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SettingsData` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `ebpsysreporttagassociation` (
  ...
  `sysModifiedDate` datetime DEFAULT NULL,
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TagId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ReportId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsysright` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ApplicationRightId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000',
  `ParentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UserId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `GroupId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Authorizations` smallint NOT NULL DEFAULT '32767',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsysrightcolumn` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `RightId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `RightTableName` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `RightColumnName` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Authorizations` smallint NOT NULL DEFAULT '32767',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `ebpsysrightvalue` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `RightId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `RightValue` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Authorizations` smallint NOT NULL DEFAULT '32767',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `ebpsysschemainformation` (
  `schemaId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `version` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `systemVersion` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `lastSynchroDate` datetime NOT NULL,
  `databaseId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `schemaMetaData` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `lastApplicationId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `lastApplicationCaption` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `lastVersion` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `lastSystemVersion` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `lastLastApplicationId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `applicationVersion` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `isCreated` tinyint(1) NOT NULL DEFAULT '0',
  `isDemo` tinyint(1) NOT NULL DEFAULT '0',
  `isBeta` tinyint(1) NOT NULL DEFAULT '0',
  `recoveryInformations` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `levelCompatibility` tinyint UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsysschemasynchronizationlog` (
  ...
  `Errors` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `SchemaIdBefore` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SchemaIdAfter` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SchemaVersionBefore` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SchemaVersionAfter` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SystemVersionBefore` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SystemVersionAfter` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ApplicationIdBefore` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ApplicationIdAfter` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ApplicationVersionBefore` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ApplicationVersionAfter` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsysstatisticcustomfilter` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Label` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ContextualFilterId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `CustomFilters` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `ebpsyssynchronizedversion` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Version` int NOT NULL DEFAULT '0',
  `VersionKonwnByDistant` int DEFAULT '0',
  `VersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsysuser` (
  ...
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000',
  `UserPassword` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '',
  `ConnectedMachine` varchar(128) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Blocked` tinyint(1) NOT NULL DEFAULT '0',
  `Unauthorized` tinyint(1) NOT NULL DEFAULT '0',
  `ActiveDirectoryUserName` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsysuserconnection` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UserId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ConnectedCount` int NOT NULL DEFAULT '0',
  `ApplicationId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `MainApplicationId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ProcessId` int DEFAULT '0',
  `ProcessName` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsysuserfunction` (
  ...
  `sysEditCounter` int DEFAULT '0',
  `Id` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Description` varchar(120) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Signature` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `UserFunctionProgram_Program` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `ReturnedDataType` tinyint UNSIGNED NOT NULL DEFAULT '1',
  `Category` int NOT NULL DEFAULT '0',
  `Example` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `NotesClear` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsysusergroupassociation` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `UserId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `GroupId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `ebpsysusermandatoryfield` (
  ...
  `ColumnName` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `LogicalSubTypeId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Conditions` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsyswebsynchronizationversion` (
  `ProviderId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Kind` tinyint UNSIGNED NOT NULL,
  `EntityId` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ebpsyswinform` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Template` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsyswingrid` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OwningId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `GridId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysEditCounter` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ebpsyswingridtemplate` (
  ...
  `OwningId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `GridId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `CategoryId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000',
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsyswinlayoutdefaulttemplate` (
  ...
  `DefaultTemplateId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `OwningId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SubTypeId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsyswinlayouttemplate` (
  ...
  `Template` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `OwningId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SubTypeId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000',
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ebpsyswinlist` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OwningId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ViewId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysEditCounter` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `economicreason` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(170) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysModuleId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysDatabaseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysRecordVersion` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ecotaxcalculationbase` (
  ...
  `NotesClear` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `CalculationBase` tinyint UNSIGNED NOT NULL DEFAULT '1',
  `UnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ecotaxfurniture` (
  ...
  `Caption` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `OrganizationId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `EcotaxCalculationBaseId` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ProducerStatus` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DecreeCategory` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DecreeFunction` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ValdeliaFamily` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MajoritoryProductMaterial` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CustomsCode` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ProductStatus` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `eventlog` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(160) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `expense` (
  ...
  `Nature` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `ThirdId` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
('CO00001', 'LEFOUL', '81dc9bdb52d04dc20036dbd8313ed055'),
('CO00002', 'GAUTHIER', '81dc9bdb52d04dc20036dbd8313ed055'),
('CO00003', 'ROLLAND', '81dc9bdb52d04dc20036dbd8313ed055'),
('CO00004', 'PFEFFER', '81dc9bdb52d04dc20036dbd8313ed055');
...
CREATE TABLE IF NOT EXISTS `intrastat` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `IntrastatState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `IntrastatNumber` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `IntrastatDate` date NOT NULL,
  `ReferencePeriod` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `IntrastatType` tinyint UNSIGNED NOT NULL DEFAULT '2',
  `ObligationLevel` smallint NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `intrastatline` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `IntrastatId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `LineNumber` int NOT NULL DEFAULT '0',
  `Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `PurchaserCeNumber` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DocumentLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DocumentType` tinyint UNSIGNED DEFAULT '0',
  `Nc8NomenclatureId` varchar(9) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DestinationCountry` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `RegimeId` varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `TransactionNatureId` varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TransportModeId` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ExpeditionFinishState` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OriginCountry` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `intrastatnc8nomenclature` (
  ...
  `Caption` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Chapter` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Sh4` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Sh6` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Nc8Section` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `intrastatregime` (
  ...
  `Id` varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `RegimeType` tinyint UNSIGNED NOT NULL DEFAULT '1',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `intrastattransportmode` (
  ...
  `NotesClear` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `DesCom` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `DesComClear` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `ItemImage` longblob,
  `BarCode` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DefaultQuantity` decimal(28,8) NOT NULL DEFAULT '1.00000000',
  `SupplierId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PurchasePrice` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  ...
  `EcotaxId` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `StockDestination` tinyint UNSIGNED DEFAULT '1',
  `StockVarianceAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CurrentStockAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Volume` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `VolumeUnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Weight` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `NetWeight` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `WeightUnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `NumberOfItemByPackage` int DEFAULT '0',
  `UseComponentVat` tinyint(1) NOT NULL DEFAULT '0',
  `ApplyPriceListOnComponents` tinyint(1) NOT NULL DEFAULT '0',
  `ComponentCalculationType` tinyint UNSIGNED DEFAULT NULL,
  ...
  `PrintComponentDetail` tinyint UNSIGNED NOT NULL DEFAULT '0',
  ...
  `ReplacementItem` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ActiveState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `NonInvoiceableType` tinyint UNSIGNED DEFAULT NULL,
  ...
  `NotPrintable` tinyint UNSIGNED DEFAULT NULL,
  `NotIncluded` tinyint UNSIGNED DEFAULT NULL,
  `IsFixedPrice` tinyint UNSIGNED DEFAULT NULL,
  `TrackingMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  ...
  `Group1` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Group2` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PriceDecimalNumber` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `IntrastatNc8NomenclatureId` varchar(9) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IsHumanServicesIncludedInAttestation` tinyint(1) NOT NULL DEFAULT '0',
  `MainIntervener` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `DimensionUnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Oxatis_Oxatis_LongDescription` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Oxatis_Oxatis_LongDescriptionClear` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  `Oxatis_Oxatis_SaleIfOutOfStockScenario` int NOT NULL DEFAULT '0',
  `Oxatis_Oxatis_ShowDaysToship` tinyint(1) NOT NULL DEFAULT '0',
  `Oxatis_Oxatis_MetaTitle` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Oxatis_Oxatis_MetaDescription` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Oxatis_Oxatis_MetaKeywords` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Oxatis_Oxatis_Brand` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `Oxatis_Oxatis_DaysToship` int NOT NULL DEFAULT '0',
  `Oxatis_Oxatis_UserMainSupplierDaysToship` tinyint(1) NOT NULL DEFAULT '1',
  `Oxatis_Oxatis_CategoryType1` tinyint UNSIGNED DEFAULT NULL,
  `Oxatis_Oxatis_CategoryType2` tinyint UNSIGNED DEFAULT NULL,
  `Oxatis_Oxatis_CategoryType3` tinyint UNSIGNED DEFAULT NULL,
  `Oxatis_Oxatis_CategoryId1` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Oxatis_Oxatis_CategoryId2` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Oxatis_Oxatis_CategoryId3` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `PurchaseUnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SalePurchaseConversionRate` decimal(28,8) NOT NULL DEFAULT '1.00000000',
  `LimitDateMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `LimitDateSafetyDelay` smallint NOT NULL DEFAULT '0',
  `LimitDateSafetyDelayMode` tinyint UNSIGNED DEFAULT '0',
  `DefaultLifeTime` smallint DEFAULT NULL,
  `PurchasePriceUpdateType` tinyint UNSIGNED DEFAULT NULL,
  `AnalyticAccounting_GridId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `BillOfQuantitiesProgram_Program` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `BillOfQuantitiesProgram_KeepActiveFromQuoteToOrder` tinyint(1) NOT NULL DEFAULT '1',
  `SaleUnitPriceProgram_Program` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `SaleUnitPriceProgram_KeepActiveFromQuoteToOrder` tinyint(1) NOT NULL DEFAULT '1',
  `PurchaseBillOfQuantitiesProgram_Program` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `PurchaseBillOfQuantitiesProgram_KeepActiveFromQuoteToOrder` tinyint(1) NOT NULL DEFAULT '1',
  `PurchaseUnitPriceProgram_Program` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  `ReplenishmentDeliveryAddressType` tinyint UNSIGNED DEFAULT NULL,
  `CatalogId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CatalogItemId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `EcotaxFurnitureId` varchar(11) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `itemaccount` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `VatId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Account` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PurchaseAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `itemcomponent` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ItemId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ParentItemId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ComponentOrder` int NOT NULL DEFAULT '0',
  `Quantity` decimal(28,8) NOT NULL DEFAULT '0.00000000',
...
CREATE TABLE IF NOT EXISTS `itemfamily` (
  ...
  `Caption` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `SupplierId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `LocationId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `StorehouseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `LimitDateMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `LimitDateSafetyDelay` smallint NOT NULL DEFAULT '0',
  `LimitDateSafetyDelayMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `VatId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `MainIntervener` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `itemfamilyaccount` (
  ...
  `Account` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PurchaseAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ItemFamilyId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ServiceAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PurchaseServiceAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `linkeditem` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ItemId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `LinkedItemId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `LineOrder` int NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `modificationlog` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ModifiedObjectId` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Type` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ModificationGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `olapcustomdatabase` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Xml` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `olaptemplatetable` (
  ...
  `Template` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Description` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `AssociatedCube` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IsSystem` tinyint(1) NOT NULL DEFAULT '0',
  `CategoryId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UserSetting_GridTitle` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UserSetting_ChartTitle` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UserSetting_ChartTitlePosition` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `UserSetting_ChartType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `UserSetting_DisplayHeader` tinyint(1) NOT NULL DEFAULT '1',
  `UserSetting_HeaderText` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `UserSetting_DisplayFooter` tinyint(1) NOT NULL DEFAULT '1',
  `UserSetting_FooterText` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  `UserSetting_LeftMargin` int NOT NULL DEFAULT '100',
  `UserSetting_RightMargin` int NOT NULL DEFAULT '100',
  `UserSetting_TopMargin` int NOT NULL DEFAULT '100',
  `UserSetting_BottomMargin` int NOT NULL DEFAULT '100',
  `UserSetting_Landscape` tinyint(1) NOT NULL DEFAULT '1',
  `UserSetting_PaperKind` tinyint UNSIGNED NOT NULL DEFAULT '9',
  `UserSetting_Watermark` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`TemplateId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `organization` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `OrganizationOfficial` tinyint UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `paymenttype` (
  ...
  `Id` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Nature` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `BankId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `BillForCollectionBook` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'OD',
  `BillForDiscountBook` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'OD',
  `OtherPaymentBook` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT 'OD',
  `BillForCollectionAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '5113',
  `BillForDiscountAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '5114',
  `OtherPaymentAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '5112',
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `payrollexchangegroupprocessdetail` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` int NOT NULL,
  `PayrollExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ProcessType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ProcessDate` datetime NOT NULL,
  `Errors` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  PRIMARY KEY (`Id`)
...
CREATE TABLE IF NOT EXISTS `periodicinvoicing` (
  ...
  `Id` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `ReferenceDocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `InvoicingMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  ...
  `DelayBeforeAssortEnabled` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `CurrencyCalculationMethod` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `SettlementModeId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `periodicinvoicingcustomer` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PeriodicInvoicingId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `CustomerId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CustomerFamilyId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `StartDate` date DEFAULT NULL,
  `EndDate` date DEFAULT NULL,
  `PreviousInvoicingDate` date DEFAULT NULL,
  `NextInvoicingDate` date DEFAULT NULL,
  `LineNumber` int NOT NULL DEFAULT '0',
  `SepaMandateIdentification` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SepaMandateDate` date DEFAULT NULL,
  `SepaSequence` tinyint UNSIGNED DEFAULT '3',
  `BankAccountId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pricelist` (
  ...
  `CalculationBase` tinyint UNSIGNED NOT NULL DEFAULT '0',
  ...
  `RoundId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pricelistcalculationline` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PriceListId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Threshold` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `CalculationType` int NOT NULL DEFAULT '4',
...
CREATE TABLE IF NOT EXISTS `pricelistinclusionline` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PriceListId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `InclusionType` tinyint UNSIGNED NOT NULL DEFAULT '4',
  `StartElementId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `EndElementId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IsExcluded` tinyint(1) NOT NULL DEFAULT '0',
  `InclusionOrder` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `purchasecommitment` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DocumentType` tinyint UNSIGNED NOT NULL DEFAULT '2',
  `DocumentSubType` tinyint UNSIGNED DEFAULT NULL,
  `DueDate` date NOT NULL,
  `Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `BalanceDue` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `IsDeposit` tinyint(1) NOT NULL DEFAULT '0',
  `PaymentTypeId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DayOfMonth` smallint DEFAULT NULL,
  `PercentageDistribution` decimal(28,8) DEFAULT NULL,
  `DaysNumber` smallint NOT NULL DEFAULT '0',
  `CommitmentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `AccountingMonth` tinyint(1) NOT NULL DEFAULT '0',
  `IsLiquidated` tinyint(1) NOT NULL DEFAULT '0',
  `AccountingTransferState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `AccountingExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ThirdId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `LiquidationAccountingTransferState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `LiquidationAccountingExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ExternalDocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CurrencyAmount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `CurrencyBalanceDue` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `LiquidationType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `PreviousLiquidationType` tinyint UNSIGNED DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `purchasedocumentcomplementarydiscount` (
  ...
  `LineOrder` int NOT NULL DEFAULT '0',
  `Code` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Caption` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Rate` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `DiscountType` tinyint UNSIGNED DEFAULT NULL,
  `CurrencyAmount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `purchasedocumentex` (
  ...
  `ShippingReverseChargeVatId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `purchasedocumentline` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ParentLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TopParentLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `LineType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `LineOrder` int NOT NULL DEFAULT '0',
  `Description` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  `UnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `StorehouseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `StockMovementId` int DEFAULT NULL,
  `ManageStock` tinyint(1) NOT NULL DEFAULT '0',
  `NomenclatureLevel` int NOT NULL DEFAULT '0',
  `IsPrintable` tinyint UNSIGNED NOT NULL DEFAULT '1',
  `QuantityDecimalNumber` smallint NOT NULL DEFAULT '0',
  `TrackingNumber` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `WeightUnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PhaseLevel` int NOT NULL DEFAULT '0',
  `Location_LocationId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Location_MultiLocationMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `DealId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Numbering` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `DeliveryState` tinyint UNSIGNED DEFAULT NULL,
  `ReturnState` tinyint UNSIGNED DEFAULT NULL,
  `OrderedQuantity` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  ...
  `VatMode` tinyint UNSIGNED DEFAULT '0',
  `NumberOfItemByPackage` int NOT NULL DEFAULT '0',
  `NetWeight` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `TotalNetWeight` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `UseComponentVat` tinyint(1) NOT NULL DEFAULT '0',
  `NomenclatureCalculationType` tinyint UNSIGNED DEFAULT NULL,
  ...
  `Discounts0_DiscountType` tinyint UNSIGNED DEFAULT NULL,
  ...
  `Discounts1_DiscountType` tinyint UNSIGNED DEFAULT NULL,
  ...
  `Discounts2_DiscountType` tinyint UNSIGNED DEFAULT NULL,
  ...
  `NotIncluded` tinyint(1) NOT NULL DEFAULT '0',
  `OtherTaxes0_Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherTaxes0_CalculationBase` tinyint UNSIGNED DEFAULT NULL,
  ...
  `OtherTaxes0_TaxUnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `OtherTaxes1_Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherTaxes1_CalculationBase` tinyint UNSIGNED DEFAULT NULL,
  ...
  `OtherTaxes1_TaxUnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `OtherTaxes2_Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OtherTaxes2_CalculationBase` tinyint UNSIGNED DEFAULT NULL,
  ...
  `OtherTaxes2_TaxUnitId` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `ItemReference` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `BillOfQuantitiesProgram_KeepActiveFromQuoteToOrder` tinyint(1) NOT NULL DEFAULT '1',
  `UnitPriceProgram_Program` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  ...
  `NumberOfPackage` int NOT NULL DEFAULT '0',
  ...
  `AnalyticPlanItemId` int DEFAULT NULL,
  ...
  `ReverseChargeVatId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `purchasedocumentlineanalyticaffectation` (
  ...
  `AnalyticPlanItem` int NOT NULL,
  `Percentage` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `DocumentLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `purchasedocumentlinetrackingdispatch` (
  ...
  `Quantity` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `StockMovementId` int DEFAULT NULL,
  `DispatchIndex` int NOT NULL DEFAULT '0',
  `LimitDate` date DEFAULT NULL,
  `LocationId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `OriginQuantity` decimal(28,8) DEFAULT '0.00000000',
  `OriginId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ReturnOriginLocationId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ReturnedQuantity` decimal(28,8) NOT NULL DEFAULT '0.00000000',
...
CREATE TABLE IF NOT EXISTS `purchasesettlement` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Reference` varchar(70) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DraweeReference` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ThirdId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SettlementDate` date NOT NULL,
  `PaymentTypeId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  ...
  `ValidationState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `AccountingExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IsLiquidated` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `LiquidationAccountingTransferState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `LiquidationAccountingExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DisbursementId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountingTransferMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ThirdBankAccountId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AssociatedOrderId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AssociatedDeliveryId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AssociatedInvoiceId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CurrencyId` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CurrencyConversionRate` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `CurrencyAmount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  ...
  `PreviousLiquidationType` tinyint UNSIGNED DEFAULT '0',
  `IsDeposit` tinyint(1) NOT NULL DEFAULT '0',
  `EconomicReasonId` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `RecoveredFrom` smallint DEFAULT NULL,
  `AcceptationId` tinyint UNSIGNED DEFAULT NULL,
  `BankRemittancePlannedDate` date DEFAULT NULL,
  `BillOfExchangeCommitmentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `BillOfExchangePointingId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `purchasesettlementcommitmentassociation` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `CommitmentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SettlementId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SecondarySettlementId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `AccountingExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `LinkedCommitmentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CurrencyId` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysModuleId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysDatabaseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
CREATE TABLE IF NOT EXISTS `recovereddocument` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DocumentNumber` varchar(18) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `NumberPrefix` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `NumberSuffix` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DocumentDate` date NOT NULL,
  `DocumentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `DocumentSubType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `SaleDocumentSubType` tinyint UNSIGNED DEFAULT '0',
  `PurchaseDocumentSubType` tinyint UNSIGNED DEFAULT '0',
  `RecoveredFrom` smallint NOT NULL DEFAULT '1',
  `CustomerId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SupplierId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ThirdName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `AmountVatExcluded` decimal(28,8) NOT NULL DEFAULT '0.00000000',
...
CREATE TABLE IF NOT EXISTS `remindercommitment` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ReminderLetterId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `CommitmentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `DocumentCurrencyId` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CommitmentCurrencyTotalAmount` decimal(28,8) DEFAULT '0.00000000',
  `CommitmentCurrencyDueAmount` decimal(28,8) DEFAULT '0.00000000',
  `NewReminderLevel` int NOT NULL DEFAULT '0',
  `SendingMode` tinyint UNSIGNED NOT NULL DEFAULT '2',
...
CREATE TABLE IF NOT EXISTS `salecommitment` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DocumentType` tinyint UNSIGNED NOT NULL DEFAULT '1',
  `DocumentSubType` tinyint UNSIGNED DEFAULT NULL,
  `DueDate` date NOT NULL,
  `Amount` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `BalanceDue` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  ...
  `GenerateSettlement` tinyint(1) NOT NULL DEFAULT '0',
  `PaymentThirdId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TotalReminderNumber` int NOT NULL DEFAULT '0',
  `LastReminderLevel` int NOT NULL DEFAULT '0',
  `LastReminderDate` date DEFAULT NULL,
  `LastReminderSendingMode` tinyint UNSIGNED DEFAULT NULL,
  `SepaMandateIdentification` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SepaMandateDate` date DEFAULT NULL,
  `SepaSequence` tinyint UNSIGNED DEFAULT '3',
  `sysModuleId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `saledocumentline` (
  ...
  `GrossInterestRateCalculationType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  ...
  `PurchaseDeliveryAddressType` tinyint UNSIGNED DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `saledocumentlinehumanservicedetail` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `LineOrder` int NOT NULL DEFAULT '0',
  `ParentLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `IntervenerId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `salesettlement` (
  ...
  `LiquidationAccountingTransferState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `LiquidationAccountingExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `BankRemittanceId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountingTransferMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ThirdBankAccountId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AssociatedOrderId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AssociatedDeliveryId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `SepaMandateIdentification` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SepaMandateDate` date DEFAULT NULL,
  `SepaDirectDebitSequence` tinyint UNSIGNED DEFAULT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `scheduleevent` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ParentEventId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `LineOrder` int NOT NULL DEFAULT '0',
  `StartDateTime` datetime NOT NULL,
  `EndDateTime` datetime NOT NULL,
  `Caption` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `EventType` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ColleagueId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `EquipmentId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `ItemId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `InvoiceColleagueId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `InvoiceCustomerId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `EventState` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ScheduleShowTimeLine` tinyint(1) NOT NULL DEFAULT '0',
  `LineType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `InvoiceId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `InvoiceLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DocumentType` tinyint UNSIGNED NOT NULL DEFAULT '1',
  `SaleDocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PurchaseDocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `StockDocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_Address1` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_Address2` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_Address3` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_Address4` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `Address_State` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_CountryIsoCode` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_Description` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Address_ThirdName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `Contact_ExternalId_GoogleId` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Contact_ExternalId_OutlookId` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CreatorColleagueId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CustomerId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SupplierId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `NextReminder` datetime DEFAULT NULL,
  `ReminderType` tinyint UNSIGNED DEFAULT '1',
  `Reminder` smallint DEFAULT '20',
  `ReminderEnabled` tinyint(1) NOT NULL DEFAULT '0',
  `PayrollExchangeGroupId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AddressId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ContactId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `settlementmode` (
  ...
  `Id` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `OxatisPaymentTypeCaption` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysEditCounter` int DEFAULT '0',
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `settlementmodeline` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `SettlementModeId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `PercentageDistribution` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `AccountingMonth` tinyint(1) NOT NULL DEFAULT '0',
  `PaymentTypeId` varchar(6) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DaysNumber` smallint NOT NULL DEFAULT '0',
  `CommitmentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `DayOfMonth` smallint DEFAULT '1',
  `GenerateCustomerSettlement` tinyint(1) NOT NULL DEFAULT '0',
  `GenerateSupplierSettlement` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `shipping` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(32) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `VatId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `CalculationMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `CalculationValue` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `CarrierAddress_Address1` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierAddress_Address2` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierAddress_Address3` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierAddress_Address4` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierAddress_ZipCode` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierAddress_City` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierAddress_State` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierAddress_CountryIsoCode` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierAddress_Longitude` decimal(20,8) DEFAULT NULL,
  `CarrierAddress_Latitude` decimal(20,8) DEFAULT NULL,
  `CarrierAddress_WebSite` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierContact_Civility` varchar(25) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierContact_Name` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierContact_FirstName` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierContact_Phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierContact_CellPhone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierContact_Fax` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CarrierContact_Email` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IntrastatTransportMode` varchar(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `NotSubjectToFinancialDiscount` tinyint(1) NOT NULL DEFAULT '0',
  `ApplyOnType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysEditCounter` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `shippingaccount` (
  ...
  `Account` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `PurchaseAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ShippingId` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `standardtext` (
  ...
  `Id` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `StandardTextClear` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `StandardText` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `states` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `StateNumber` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Caption` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `CountryIsoCode` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `statisticview` (
  ...
  `Caption` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `Content` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `StatisticType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `stockdocument` (
  ...
  `DocumentDate` date NOT NULL,
  `GlobalDocumentOrder` int NOT NULL,
  `StorehouseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `DealId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DocumentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `OriginDocumentType` tinyint UNSIGNED DEFAULT NULL,
  `ValidateState` tinyint UNSIGNED DEFAULT NULL,
  `GroupingType` tinyint UNSIGNED DEFAULT NULL,
  `SortingType` tinyint UNSIGNED DEFAULT NULL,
  ...
  `ValidationGlobalDocumentOrder` int DEFAULT NULL,
  `DocumentStage` tinyint UNSIGNED NOT NULL DEFAULT '1',
  `OriginDocumentId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TransitStorehouseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TransitEndDate` date DEFAULT NULL,
  `TransitDuration` int DEFAULT NULL,
  ...
  `ItemValueType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `sysEditCounter` int DEFAULT '0',
  `sysModuleId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysDatabaseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysRecordVersion` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `stockdocumentline` (
  ...
  `Commentary` varchar(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `LocationCaption` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UnitCaption` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `TargetStockMovementId` int DEFAULT NULL,
  `StockChargeAmount` decimal(28,8) DEFAULT NULL,
  `GapStockMovementId` int DEFAULT NULL,
  `OriginLineId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `RemainingQuantity` decimal(28,8) DEFAULT NULL,
  `TargetQuantity` decimal(28,8) DEFAULT NULL,
  `TransitInputStockMovementId` int DEFAULT NULL,
  `TransitOutputStockMovementId` int DEFAULT NULL,
  `ExistingTrackingNumber` tinyint(1) NOT NULL DEFAULT '0',
  `TrackingMasterLine` tinyint(1) NOT NULL DEFAULT '0',
  `UpdateComponentsStockInFabrication` tinyint(1) NOT NULL DEFAULT '0',
  `TransitLocation_LocationId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TransitLocation_MultiLocationMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `TargetLocation_LocationId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TargetLocation_MultiLocationMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `stockdocumentlinetrackingdispatch` (
  ...
  `RemainingQuantity` decimal(28,8) DEFAULT NULL,
  `TargetQuantity` decimal(28,8) DEFAULT NULL,
  `TransitLocationId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TargetLocationId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `stockitem` (
  ...
  `SuppliersDeliveryOrderPreparingQuantity` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `SuppliersReturnOrderPreparingQuantity` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `MultiLocationMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `stockmovement` (
  ...
  `StorehouseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DocumentDate` date NOT NULL,
  `DocumentOrder` int NOT NULL DEFAULT '0',
  `DocumentNumber` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `DocumentType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `DocumentSubType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `Quantity` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  ...
  `RealStock` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `StockValue` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `ReferenceMovementId` int DEFAULT NULL,
  `StockChargeAmount` decimal(28,8) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `storehouse` (
  ...
  `MultiLocationDefaultMode` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `supplieritem` (
  ...
  `DeliveryDelay` int NOT NULL DEFAULT '0',
  ...
  `ReferenceId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `EcotaxId` varchar(8) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `suppliersubfamily` (
  ...
  `Id` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Caption` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `SupplierFamilyId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `AnalyticAccounting_GridId` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `UniqueId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tax` (
  ...
  `SaleAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '447',
  `PurchaseAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '447',
  `sysEditCounter` int DEFAULT '0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `taxitem` (
  ...
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ItemId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ItemFamilyId` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `TaxId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `TaxOrder` int NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `thirdbankaccountdetail` (
  ...
  `AccountDetail_InternationalBankAccountNumber` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountDetail_BankIdentifierCode` varchar(11) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountDetail_Caption` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountDetail_CountryIsoCode` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountDetail_Domiciliation1` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountDetail_Domiciliation2` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountDetail_Domiciliation3` varchar(60) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `AccountDetail_OtherBankIdentifier` varchar(13) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `IsActive` tinyint(1) NOT NULL DEFAULT '1',
  `CustomerId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SupplierId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `SepaMandateIdentification` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `thirdreference` (
  ...
  `sysModifiedUser` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ReferenceThirdType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ThirdSelectionType` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `ThirdId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ItemId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `trackingstockitem` (
  ...
  `StorehouseId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `RealStock` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `TrackingNumber` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `UnitValue` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `StockValue` decimal(28,8) NOT NULL DEFAULT '0.00000000',
  `LimitDate` date DEFAULT NULL,
  `AdjustedLimitDate` date DEFAULT NULL,
  `LocationId` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `unit` (
  ...
  `Caption` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `UnitType` tinyint UNSIGNED NOT NULL DEFAULT '5',
...
CREATE TABLE IF NOT EXISTS `vat` (
  ...
  `SellingCollectionVatAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '44571',
  `SellingDebitVatAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '44571',
  `SellingGoodsAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '707',
  `SellingServicesAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '706',
  `SellingShippingAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '7085',
  `SellingEcotaxAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '7088',
  `SellingEcotaxFurnitureAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '7088',
  `PurchaseCollectionVatAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '44566',
  `PurchaseDebitVatAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '44566',
  `PurchaseGoodsAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '607',
  `PurchaseServicesAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '604',
  `PurchaseShippingAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '6241',
  `PurchaseEcotaxAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '6088',
  `PurchaseEcotaxFurnitureAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '6088',
  `REAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '477',
  `GoodsReverseChargeAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '4452',
  `ServicesReverseChargeAccount` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT '4452',
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(5, 'CO00002', '', 19, 'Queffelec', 'Weaver', '2020-04-23 04:39:10', 'Ulichnoye', ''),
(6, 'CO00002', '', 48, 'Léandre', 'Payne', '2020-03-18 01:01:11', 'Quán Hành', ''),
(7, 'CO00002', '', 47, 'Dafnée', 'Garcia', '2020-10-16 19:39:28', 'Redange-sur-Attert', ''),
(8, 'CO00002', '', 6, 'Réservés', 'Smith', '2020-08-22 21:21:15', 'Machala', ''),
(9, 'CO00002', '', 44, 'Tán', 'Wood', '2020-04-18 10:00:59', 'Grand Bois', ''),
(10, 'CO00002', '', 23, 'Estée', 'Hayes', '2020-02-16 17:03:40', 'Dawuhanmangli', ''),
(11, 'CO00003', '', 22, 'Queffelec', 'Sanders', '2020-10-17 16:00:14', 'Teeli', ''),
(12, 'CO00003', '', 25, 'Vénus', 'Hanson', '2020-06-24 13:06:09', 'Ungheni', ''),
(13, 'CO00003', '', 42, 'Hélène', 'Dean', '2020-05-29 19:50:38', 'Castelo', ''),
(14, 'CO00003', '', 16, 'Maëlann', 'Harvey', '2020-12-31 06:27:43', 'Aguadulce', ''),
(15, 'CO00003', '', 2, 'Méthode', 'Thompson', '2020-04-06 09:09:55', 'Dam?vand', ''),
(16, 'CO00004', '', 33, 'Joséphine', 'Fox', '2020-01-13 21:47:48', 'Shangcunba', ''),
(17, 'CO00004', '', 24, 'Marie-josée', 'Palmer', '2020-07-04 15:41:45', 'Keluke', ''),
(18, 'CO00004', '', 33, 'Aimée', 'Kennedy', '2020-03-20 17:38:59', 'Koronowo', ''),
(19, 'CO00004', '', 7, 'Médiamass', 'Sanders', '2020-11-05 02:31:49', 'D?bowiec', ''),
(20, 'CO00004', '', 42, 'Naéva', 'Nguyen', '2020-10-15 02:00:01', 'D?bnica Kaszubska', ''),
(24, 'CO00003', 'c682cbf4-915d-445f-9f21-02b3883bbb2i', 37, 'Lefahouet', 'Richard', '2020-09-10 00:00:00', 'test', 'test test'),
(26, 'CO00001', 'c682cbf4-915d-445f-9f21-02b3883bbb2d', 23, 'Lemoine', 'Jean-Claude', '2021-06-07 00:00:00', 'rennes', ''),
(27, 'CO00001', 'c682cbf4-915d-445f-9f21-02a3883bab2c', 23, 'Martin', 'Georges', '2021-06-08 00:00:00', 'rennes', ''),
(28, 'CO00001', '965d7d5f-72e1-4831-969f-3817e9c4876f', 23, 'Alapoulos', 'Christofa', '2021-06-08 00:00:00', 'montfort', 'eglise');
...
CREATE TABLE IF NOT EXISTS `zipcode` (
  ...
  `Notes` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `Id` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ZipCode` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `City` varchar(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `StateId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `CountryIsoCode` varchar(3) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `sysRecordVersion` int DEFAULT '0',
  `sysRecordVersionId` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
